...
describe("StructuredConditionsField carriers orbiting", () => {
    beforeEach(() => {
    ...
    it("switches a row to carriers_orbiting and stores the new kind", () => {
        render(
            <ThemeProvider>
                <PortalManager>
        ...
        fireEvent.change(screen.getByDisplayValue("fact_threshold"), {
            target: { value: "carriers_orbiting" },
        });
